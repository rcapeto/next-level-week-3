...
import { Linking, Image, View, ScrollView, Text, StyleSheet, Dimensions, ActivityIndicator, TouchableOpacity } from 'react-native';
...
export default function OrphanageDetails() {
  ...
  async function getOrphanageDetail() {
    ...
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false}>
          {
            orphanage.images.length > 0 && orphanage.images.map(image => (
              <Image source={{ uri: image.url }} key={image.id} style={styles.image}/>
            ))
          }
        </ScrollView>
      </View>
