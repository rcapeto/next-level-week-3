...
export default function OrphanageData() {
   ...
   async function handleCreateOrphanage() {
      ...
      if(
         ...
         return Alert.alert('Happy', 'Por favor preencha todos os campos!');
      }
   ...
   async function handleSelectImages() {
      ...
      if(status !== 'granted') {
         Alert.alert('Happy', 'Eita... precisamos de acesso às suas fotos!');
         return;
      }
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <View style={styles.uploadedImagesContainer}>
         {images.map((image, index) => (
            <Image source={{ uri: image }} style={styles.uploadedImage} key={index}/>
         ))}
      </View>
      ...
      <TextInput
        style={styles.input}
        value={opening_hours}
        onChangeText={setOpeneningHours}
      />
